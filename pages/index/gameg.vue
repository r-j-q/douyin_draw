 ...
 -->
        ...
        <!-- <blowAny  canvasId="canvasId2" :height="200" :width="600" refs="card" style="margin: 0 40upx;" @complete="seatShow"
         ...
         <view class="" style="width: 90%;margin: 0 auto;">
         	<aylottery :chance_num_init="chance" :type="6" :disabled="disabled" canvasId="canvasId3" :height="200" :width="600" refs="card" @complete="seatShow"
         	 title="" watermark="刮一刮" @init="init_blow">
         	    <view class="gua-gua" style="position: absolute;top: 0;left: 0;right: 0;" v-if="is_show_blow">
         	         <view class="color___">
         	             {{name}}
         	        </view>
         	    </view>
